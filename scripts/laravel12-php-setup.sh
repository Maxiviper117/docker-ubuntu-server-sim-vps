...
### 6. Supervisor for queue workers, etc.
# (Supervisor config for 'php artisan serve' removed; use PHP-FPM with Nginx/Caddy in production)

# Example: To supervise a queue worker, you could use:
...
#   https://dl.cloudsmith.io/public/caddy/stable/debian.deb.txt nodistro main" \
